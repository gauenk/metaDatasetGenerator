...
outputDir = "./output/al/"
testCommandTemplate = "./tools/test_net.py --imdb {:0}-test-default --cfg ./experiments/cfgs/cls_{:0}.yml --def ./models/{:0}/{:1}/test.prototxt --net ./output/classification/{:0}/{:2}_iter_{:3}.caffemodel"
...
def testIterModel(nIters,modelType,ogModelName,datasetName):
    setTestCommand = testCommandTemplate.format(datasetName,modelType,ogModelName,nIters)
...
if __name__ == "__main__":
    ...
    ogModelName = "solverForTesting_alSubset"
    ...
    saveFn = "./{:0}_validation_accuracy_{:1}.pkl".format(datasetName,ogModelName)
