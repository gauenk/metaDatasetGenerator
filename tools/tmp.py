...
from datasets.ds_utils import adversarialPerturbation
import caffe
import argparse
import pprint
import time, os, sys
...
if __name__ == '__main__':
    ...
    cls = roidb[i]['gt_classes'][0]
    img = cv2.imread(img_path)
    inputBlob = {'data': img}
    inputBlob = {'labels': }
    adversarialPerturbation(img,net,inputBlob,inputBlobImgFieldName,inputBlobLabelFieldName,outputFieldName,targetOutput,alpha=0.1)
