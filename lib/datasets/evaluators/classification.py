...
class classificationEvaluator(object):
    ...
    def cls_eval(self,detpath,
        ...
        # first load gt
        imagenames, probs = load_groundTruth(classname)

        # extract gt objects for this class
        imagenames, gt_class_probs, npos, nneg = extractClassGroundTruth(imagenames,probs,classname)
        ...
        tp, tn, fp, fn = compute_metrics(ovthresh,image_ids,model_probs,gt_class_probs)
        # print(np.sum(tp))
